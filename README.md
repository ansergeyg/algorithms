...
то здесь мы перебираем значения каждого бита и <b>сопоставляем</b> со значением каждого другого бита.<p>
